...
namespace L7_2
{
    ...
    class ProductRange
    {
        public int[] ProductNumber = new int[Sizing()-1];
        public string[] Title = new string[Sizing() - 1];
        public double[] Weight = new double[Sizing() - 1];
        public int[] ProductionCost = new int[Sizing() - 1];
        public int[] SellingPrice = new int[Sizing() - 1];
